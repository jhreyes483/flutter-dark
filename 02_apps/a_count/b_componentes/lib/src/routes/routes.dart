import 'package:b_componentes/src/pages/animated_container.dart';
import 'package:b_componentes/src/pages/card_page.dart';
import 'package:b_componentes/src/pages/input_page.dart';
import 'package:b_componentes/src/pages/listview_page.dart';
import 'package:b_componentes/src/pages/slider_page.dart';
import 'package:b_componentes/src/pages/test_imagen.dart';
...
Map<String, WidgetBuilder> getApplicationRoutes() {
  return <String, WidgetBuilder>{
    ...
    'imagen'               : (BuildContext context) => TestImagen(),
  };
}
